...
const { getQrReview, validateToken, submitReview, identifyCustomer } = require('../controllers/public.controller');
...
router.post('/:token/identify', asyncWrap(identifyCustomer));
